...
export default function Header() {
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b bg-card px-4 sm:px-6">
      <div className="flex w-full items-center justify-center sm:justify-start sm:w-auto gap-3">
      ...
      <div className="absolute sm:relative right-4 flex items-center gap-2">
        <DropdownMenu>

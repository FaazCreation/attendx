...
import { HelpCircle, Users, Camera, Calendar, Share2, Info, CreditCard } from "lucide-react";
    ...
    items: [
      {
        ...
        answer: "নতুন সেশনের শুরুতে আমরা সদস্য সংগ্রহ করি। তবে আপনি যদি ফটোগ্রাফিতে বিশেষ দক্ষ হন এবং পূর্ব অভিজ্ঞতা থাকে, তবে নির্ধারিত সময়ের বাইরেও আমাদের অফিশিয়াল মেইলে আপনার কাজের পোর্টফোলিওসহ বিস্তারিত তথ্য পাঠিয়ে আবেদনের সুযোগ রয়েছে। সাধারণ প্রক্রিয়ায় অনলাইন ফর্ম পূরণ এবং ১০০ টাকা রেজিস্ট্রেশন ফি দিয়ে সদস্যপদ গ্রহণ করতে হয়।"
      },
      {
      ...
      {
        question: "নিয়োগের সময় ছাড়া কি যোগ দেওয়া সম্ভব?",
        answer: "হ্যাঁ, যদি আপনি দক্ষ হন এবং আপনার পূর্ব অভিজ্ঞতা থাকে, তবে আপনি ক্লাবের অফিশিয়াল মেইলে বিস্তারিত ইমেইল করলে পরিচালনা কমিটি আপনার যোগ্যতা বিবেচনা করে যুক্ত হওয়ার সুযোগ দিতে পারে।"
      }
    ]
  },
  {
    id: "fees",
    title: "ফি ও আর্থিক নিয়ম",
    description: "সদস্য ফি এবং পেমেন্ট সংক্রান্ত তথ্য।",
    icon: CreditCard,
    items: [
      {
        question: "রেজিস্ট্রেশন ফি এবং মাসিক ফি কত?",
        answer: "আমাদের সদস্য রেজিস্ট্রেশন ফি ১০০ টাকা। এছাড়া সক্রিয় সদস্য হিসেবে নিয়মিত মাসিক ফি ১০০ টাকা প্রদান করতে হয়।"
      },
      {
        question: "আমি কি অগ্রিম ফি পরিশোধ করতে পারি?",
        answer: "অবশ্যই। আপনি চাইলে আপনার সুবিধার জন্য অগ্রিম বার্ষিক ফি একসাথে পরিশোধ করতে পারেন।"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "হ্যাঁ, আমাদের ইভেন্টগুলোতে ব্র্যান্ড প্রমোশন এবং স্পন্সরশিপের সুযোগ রয়েছে। আগ্রহী প্রতিষ্ঠানগুলো আমাদের অফিশিয়াল ইমেইল বা ইনবক্সে প্রস্তাব পাঠাতে পারেন।"
      }
    ]
  }
];
        ...
        <Card className="bg-primary/5 border-dashed border-primary/20">
          <CardContent className="flex flex-col items-center justify-center p-8 text-center space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-lg">
              যদি আপনি উপরে আপনার উত্তর খুঁজে না পান, তবে সরাসরি আমাদের অফিসিয়াল ফেসবুক পেজে মেসেজ করুন অথবা আমাদের মেইল করুন। অভিজ্ঞ ও দক্ষ হলে যেকোনো সময় ইমেইলের মাধ্যমে যুক্ত হওয়ার সুযোগ রয়েছে।
            </p>
          </CardContent>
        </Card>
      </div>

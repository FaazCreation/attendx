...
const committeeMembers = [
  { id: 1, name: "মোকাদ্দেসুর রহমান সান", role: "সভাপতি", department: "টিএমএস", batch: "২০২০-২১" },
  { id: 2, name: "আরেফিন তানভীর", role: "সাধারণ সম্পাদক", department: "মার্কেটিং", batch: "২০২০-২১" },
  { id: 3, name: "তৌহিদ ইসলাম", role: "সাংগঠনিক সম্পাদক", department: "ম্যানেজমেন্ট", batch: "২০২৩-২৪" },
  { id: 4, name: "ফরহাদ হোসেন", role: "প্রধান সৃজনশীল ও আইটি", department: "অর্থনীতি", batch: "২০২৩-২৪" },
  { id: 5, name: "নিয়াজ করিম রাকিব", role: "কোষাধ্যক্ষ", department: "অর্থনীতি", batch: "২০২১-২২" },
  { id: 6, name: "শূন্যপদ", role: "প্রধান নির্বাহী", department: "প্রযোজ্য নয়", batch: "প্রযোজ্য নয়" },
  { id: 7, name: "শূন্যপদ", role: "জনসংযোগ কর্মকর্তা", department: "প্রযোজ্য নয়", batch: "প্রযোজ্য নয়" },
  { id: 8, name: "সাইফুল্লাহ আল রাতুল", role: "ইভেন্ট কোঅর্ডিনেটর", department: "মার্কেটিং", batch: "২০২০-২১" },
  { id: 9, name: "ইমতিয়াজ হোসেন তমাল", role: "আলোকচিত্রী", department: "বিবিএ", batch: "২০২১-২২" },
  { id: 10, name: "মাসুম বিল্লাহ", role: "ভিডিওগ্রাফার", department: "রাষ্ট্রবিজ্ঞান", batch: "২০২২-২৩" },
  { id: 11, name: "শূন্যপদ", role: "কন্টেন্ট ক্রিয়েটর", department: "প্রযোজ্য নয়", batch: "প্রযোজ্য নয়" },
  { id: 12, name: "মাইদুল ভূঁইয়া", role: "গ্রাফিক ডিজাইনার", department: "মার্কেটিং", batch: "২০২৩-২৪" },
];
